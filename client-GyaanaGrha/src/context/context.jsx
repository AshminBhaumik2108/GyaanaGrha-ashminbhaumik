...
const ContextProvider = (props) => {
  ...
  // for Sidebar : For the Extended View..... (Used in useContext if Needed for other functionalities as Well...)
  ...
  const onSent = async (prompt) => {
    // At the End I dod't need this...
    // for the Check properties and the Values I have Written Accordingly... But I have never Used...
    ...
    // Mainly used to append the previous prompts....
